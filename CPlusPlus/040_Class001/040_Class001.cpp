...
// c++ 에서 클래스는 모든것을 만들 수 있는 문법입니다.
// int도 이 내가 만드는 개념과 다르지 않는다는 것을 곧 알게 됩니다.
class Player
{
    // 2가지를 가지고 있습니다.
    // 속성과
...
// 자료형
// 기본자료형 int bool
// 사용자정의 자료형 Player, Monster FightZone => 모든 것을 표현할 수 있다.
