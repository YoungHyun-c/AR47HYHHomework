// 092_String_view.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//

#include <iostream>
#include <string_view> // 20년 이상 최신버전부터 사용가능하다.
...
// const를 붙이는 이유는 의도를 보여주기 위함이다. => 함수안에 너가 넣어준 인자가 변형되지 않을거야
// 속력과 의도를 전부다 잡는 것.
...
void StringFunction(const std::string& _Value)
{
