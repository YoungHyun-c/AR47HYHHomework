// 093_functional.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//

#include <iostream>
#include <functional>

// template<typename ButtonCallType> 이럴껀 아니다.
class Button
{
public:
	// 멤버변수도 쓰고 싶은데
...
int main()
{
	...
	// 함수포인터긴 함수포인터인데
	// 1. 전역도 받을 수 있고.
	// 2. 멤버도 받을 수 있고 <= 클래스제한없이
	// 3. 인자의 제한도 없는 함수포인터가 있었으면 좋겠다.
